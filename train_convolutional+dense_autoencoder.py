...
x = MaxPooling2D(MAX_POOLING_SIZE,MAX_POOLING_SIZE)(x)
...
first_decoder_layer = Dense(32, activation='relu', name="first_decoder_layer")(last_encoder_layer)
x = Dense(64, activation='relu')(first_decoder_layer)
x = Dense(256, activation='relu')(x)
x = Dense(1024, activation='relu')(x)
x = Reshape((int(TRAIN_PATCH_HEIGHT/(MAX_POOLING_SIZE*MAX_POOLING_SIZE)), int(TRAIN_PATCH_WIDTH/(MAX_POOLING_SIZE*MAX_POOLING_SIZE)), 64))(x)
